...
public class Main_Form_CVC : MonoBehaviour
{
   ...
   public void onclicking()
   {
        ...
        if(G_selected.tag=="answer")
        {
            ...
            if (G_selected.name == "cup")
            {
                I_letter_count++;
                GA_Dashes[5].SetActive(false);
                GA_Letters[5].SetActive(true);
                G_Blur_names[5].SetActive(true);
                onblur();
            }
        }
        else
    ...
    public void onblur()
    {
       ...
       // ANIM_empty = G_selected.GetComponent<Animator>();
        ...
        Invoke("offblur", 100f*Time.deltaTime);
    }
    ...
    public void offblur()
    {
        ...
        if (I_letter_count < 6)
        {
            if (I_letter_count % 2 == 0)
            {
                Invoke("changeoption", 20f * Time.deltaTime);
            }
        }
        if (I_letter_count == 6)
        {
